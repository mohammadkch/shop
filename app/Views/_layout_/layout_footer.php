...
<footer class="custom-gradient">
    <!--Services section-->
    <div class="bg-gray-200 dark:bg-gray-900 py-2.5 transition-colors duration-300">
        <div class="container">
                    ...
                    <ul class="flex justify-between space-y-3 w-full flex-wrap">
                            ...
                            <div class="flex items-center p-2">
                                <div class="flex-shrink-0">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="41" viewBox="0 0 34 41" fill="none">
                                        ...
                                        <path d="M29.7593 37.6803C29.2993 37.6803 28.8517 37.4415 28.6052 37.0145C28.2376 36.3777 28.4558 35.5635 29.0925 35.1959L31.6352 33.7279C32.2719 33.3603 33.0861 33.5783 33.4538 34.2152C33.8215 34.8519 33.6032 35.6661 32.9666 36.0337L30.4238 37.5018C30.2141 37.6227 29.9852 37.6803 29.7593 37.6803Z" fill="#43386B"></path>
                                        <path d="M17.5133 31.4645C17.5133 26.9083 14.7432 21.6154 11.3259 19.6424C9.60805 18.6507 8.15517 18.7225 6.93284 19.547L4.28394 21.0763L12.653 38.0426L15.5254 36.3748C16.7477 35.5735 17.5133 33.8594 17.5133 31.4645Z" fill="url(#paint000000_linear)"></path>
                                        <path d="M12.391 38.1675C15.1214 37.0041 15.6678 32.1485 13.6114 27.3221C11.5549 22.4958 7.6744 19.5264 4.94394 20.6898C2.21348 21.8533 1.66707 26.7089 3.72351 31.5352C5.77994 36.3616 9.66049 39.3309 12.391 38.1675Z" fill="#A996EB"></path>
                                        <path d="M13.1969 33.3413C13.1969 37.4207 10.7167 39.2958 7.65711 37.5293C4.59756 35.7629 2.11731 31.024 2.11731 26.9446C2.11731 22.8652 4.59756 20.9902 7.65711 22.7566C10.7167 24.523 13.1969 29.262 13.1969 33.3413Z" fill="url(#paint111111_linear)"></path>
                                        <path d="M9.48221 32.697C9.48221 35.1242 8.00646 36.2399 6.18599 35.1889C4.36553 34.1378 2.88977 31.3181 2.88977 28.8909C2.88977 26.4636 4.36553 25.348 6.18599 26.3989C8.00646 27.45 9.48221 30.2697 9.48221 32.697Z" fill="url(#paint222222_linear)"></path>
                                        <path d="M33.9999 21.2676C33.9999 25.347 31.5196 27.222 28.4601 25.4556C25.4005 23.6892 22.9203 18.9502 22.9203 14.8708C22.9203 10.7915 25.4005 8.91642 28.4601 10.6829C31.5196 12.4492 33.9999 17.1882 33.9999 21.2676Z" fill="url(#paint333333_linear)"></path>
                                        <path d="M33.7523 22.0759C33.7523 17.5196 30.9821 12.2267 27.5649 10.2538C25.847 9.26199 24.3941 9.33381 23.1717 10.1583L20.5228 11.6877L28.8919 28.6539L31.4699 27.157C31.5707 27.1057 31.6689 27.0487 31.7643 26.9862C32.9867 26.1848 33.7523 24.4707 33.7523 22.0759Z" fill="url(#paint444444_linear)"></path>
                                        <path d="M28.6234 28.773C31.3538 27.6096 31.9002 22.7539 29.8438 17.9276C27.7874 13.1013 23.9068 10.1319 21.1764 11.2953C18.4459 12.4587 17.8995 17.3144 19.9559 22.1407C22.0124 26.967 25.8929 29.9364 28.6234 28.773Z" fill="#A996EB"></path>
                                        <path d="M28.7449 22.2724C28.7449 25.1072 27.0214 26.4101 24.8953 25.1827C22.7692 23.9552 21.0457 20.662 21.0457 17.8272C21.0457 14.9925 22.7692 13.6896 24.8953 14.917C27.0214 16.1445 28.7449 19.4376 28.7449 22.2724Z" fill="url(#paint555555_linear)"></path>
                                        <path d="M26.5291 3.82278C26.5727 3.82897 26.5964 3.83239 26.5964 3.83239L26.0507 3.51739C26.0507 3.51739 26.0507 3.51731 26.0506 3.51731C26.0506 3.51731 26.0505 3.51724 26.0504 3.51724C26.0504 3.51724 20.9606 0.607194 20.8383 0.590988C18.9758 -0.276622 16.8468 -0.189154 15.0387 0.854743C9.92292 3.80832 6.745 9.31269 6.745 15.2198V19.7403C7.48581 19.7498 8.30035 19.9888 9.15549 20.4825C9.96606 20.9505 10.7394 21.607 11.4488 22.3944V22.4107L12.6913 21.6933V17.8823C12.6913 12.4178 15.6312 7.32571 20.3637 4.59339C21.0843 4.17734 21.8685 3.951 22.6585 3.91303C23.0467 4.63509 23.2579 5.4548 23.2579 6.31756V10.1688C23.9898 10.1849 24.7926 10.4236 25.6348 10.9099C26.4582 11.3853 27.2433 12.0549 27.9618 12.8589V12.8768L29.2043 12.1594V8.98006C29.2045 6.89059 28.2141 5.00165 26.5291 3.82278Z" fill="url(#paint666666_linear)"></path>
                                        <path d="M12.6912 21.6932V17.8823C12.6912 12.4177 15.6311 7.32567 20.3636 4.59335C21.9495 3.67775 23.843 3.67767 25.429 4.59335C27.0149 5.50894 27.9616 7.14891 27.9616 8.9801V12.8768L29.2041 12.1595V8.9801C29.2041 6.69965 28.025 4.65754 26.0502 3.51728C24.0752 2.37701 21.7172 2.37709 19.7423 3.51728C14.6265 6.47085 11.4486 11.9752 11.4486 17.8823V22.4106L12.6912 21.6932Z" fill="#A996EB"></path>
                                        <path d="M22.6668 40.6753C22.1264 40.6753 21.5858 40.5361 21.1037 40.2578L15.1723 36.8333C14.8752 36.6617 14.7733 36.2818 14.9449 35.9846C15.1165 35.6874 15.4965 35.5856 15.7936 35.7572L21.725 39.1817C22.3061 39.5172 23.028 39.517 23.6087 39.1817L28.8933 36.1307C29.1906 35.9592 29.5705 36.0609 29.742 36.358C29.9136 36.6552 29.8117 37.0351 29.5146 37.2067L24.23 40.2578C23.7479 40.5361 23.2074 40.6753 22.6668 40.6753Z" fill="#A996EB"></path>
                                        <defs>
                        ...
                        <li class="flex lg:w-auto sm:w-1/2 w-full">
                            <div class="flex items-center p-2">
                                ...
                                <div class="ms-3 space-y-2">
                                    <p class="text-sm text-gray-900 dark:text-gray-100">
                                        فرصت 7 روزه <strong class="text-primary dark:text-primary-400">بازگشت کالا</strong>
                                    </p>
                                    <small class="text-gray-500 dark:text-gray-400 text-xs">
                            ...
                            <div class="flex items-center p-2">
                                <div class="flex-shrink-0">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="39" viewBox="0 0 38 39" fill="none">
                                        ...
                                        <path d="M31.9065 28.737V8.85791L1.92626e-08 10.2262V30.1053C-7.60807e-05 30.5608 0.225332 31.0163 0.676148 31.2766L13.3157 38.5741C14.2146 39.0931 15.3221 39.0931 16.2211 38.5741L31.2304 29.9084C31.6812 29.6481 31.9066 29.1926 31.9065 28.737Z" fill="url(#paint000_linear)"></path>
                                        <path d="M0.676533 9.0549L15.6859 0.389251C16.5849 -0.12975 17.6923 -0.12975 18.5912 0.389251L31.2307 7.6867C32.1323 8.20723 32.1323 9.50854 31.2307 10.0291L16.2214 18.6946C15.3224 19.2136 14.2149 19.2136 13.3161 18.6946L0.676533 11.3973C-0.225023 10.8767 -0.225023 9.57543 0.676533 9.0549Z" fill="url(#paint111_linear)"></path>
                                        <path d="M5.54309 6.2452L21.6638 15.5525L25.94 13.0836L9.8193 3.77637L5.54309 6.2452Z" fill="#DEA861"></path>
                                        <path d="M8.09862 4.76807L24.2193 14.0754L23.3817 14.559L7.26099 5.25168L8.09862 4.76807Z" fill="#CC8241"></path>
                                        <path d="M21.6635 15.5524V19.0839L25.9397 16.615V13.0835L21.6635 15.5524Z" fill="#CC8241"></path>
                                        <path d="M37.5998 15.0849C37.5293 15.0316 37.4542 14.9903 37.3768 14.9582L34.3016 13.2114C33.8048 12.8358 33.0897 12.9963 32.8009 13.5481L27.067 24.5894L27.0059 24.5433C26.8234 24.4053 26.6234 24.3119 26.4174 24.2556L26.4158 24.2526L23.7078 22.6698C23.5601 22.5581 23.4008 22.4759 23.2363 22.418L23.2305 22.4146L23.2311 22.416C22.4454 22.1423 21.5361 22.4654 21.1261 23.2488C20.733 23.9998 20.9405 24.9248 21.6166 25.4359L26.8342 29.3803L30.1323 31.2538L37.8849 16.3563C38.1136 15.9197 37.9929 15.382 37.5998 15.0849Z" fill="url(#paint222_linear)"></path>
                                        <path d="M27.0061 24.5435C26.8236 24.4055 26.6235 24.3121 26.4176 24.2557L26.416 24.2528L23.708 22.67C23.5603 22.5583 23.401 22.4761 23.2365 22.4182L23.2307 22.4148L23.2314 22.4162C22.4457 22.1425 21.5364 22.4656 21.1264 23.249C20.7333 24 20.9408 24.925 21.6169 25.4361L26.8344 29.3805L30.1325 31.254L27.0061 24.5435Z" fill="url(#paint333_linear)"></path>
                                        <path d="M30.1324 31.2537L24.9148 27.3094C24.2387 26.7983 24.0312 25.8732 24.4243 25.1224C24.9211 24.1732 26.1514 23.8972 27.006 24.5433L30.1324 26.9069L36.0991 15.4216C36.3879 14.8698 37.1029 14.7094 37.5998 15.0849C37.9928 15.382 38.1134 15.9197 37.885 16.3563L30.1324 31.2537Z" fill="#06DAAE"></path>
                                        <defs>
                                ...
                                <div class="ms-3 space-y-2">
                                    <p class="text-sm text-gray-900 dark:text-gray-100">
                                        تضمین <strong class="text-primary dark:text-primary-400">کیفیت کالا</strong>
                                    </p>
                                    <small class="text-gray-500 dark:text-gray-400 text-xs">
                            ...
                            <div class="flex items-center p-2">
                                <div class="flex-shrink-0">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="38" viewBox="0 0 42 38" fill="none">
                                        ...
                                        <path d="M30.3848 27.3661V8.43506L-3.04972e-05 9.73799V28.669C-0.000106853 29.1028 0.214529 29.5366 0.643877 29.7845L12.6805 36.7338C13.5365 37.2281 14.5912 37.2281 15.4473 36.7338L29.7408 28.4815C30.1701 28.2336 30.3848 27.7998 30.3848 27.3661Z" fill="url(#paint0000_linear)"></path>
                                        <path d="M0.643907 8.62305L14.9374 0.370687C15.7934 -0.123562 16.8481 -0.123562 17.7042 0.370687L29.7408 7.32004C30.5994 7.81574 30.5994 9.05499 29.7408 9.55069L15.4474 17.803C14.5913 18.2972 13.5366 18.2972 12.6805 17.803L0.643907 10.8536C-0.214636 10.3579 -0.214636 9.11875 0.643907 8.62305Z" fill="url(#paint1111_linear)"></path>
                                        <path d="M5.27853 5.94733L20.6304 14.8107L24.7026 12.4596L9.35081 3.59619L5.27853 5.94733Z" fill="#DEA861"></path>
                                        <path d="M7.71238 4.54102L23.0642 13.4044L22.2665 13.8649L6.91469 5.00159L7.71238 4.54102Z" fill="#CC8241"></path>
                                        <path d="M20.6303 14.8106V18.1737L24.7026 15.8226V12.4595L20.6303 14.8106Z" fill="#CC8241"></path>
                                        <path d="M36.6821 15.1712L36.6825 15.1705L33.5126 13.3456L33.5124 13.346C32.2611 12.683 30.6537 12.7774 28.9 13.7899C24.9101 16.0935 21.6756 22.2737 21.6756 27.5937C21.6756 30.5186 22.6545 32.5717 24.1979 33.4473L24.1968 33.4496L27.0932 35.1218L27.0961 35.1156C28.3692 35.8766 30.0393 35.8217 31.8697 34.7649C35.8597 32.4613 39.0942 26.2811 39.0942 20.9611C39.0942 18.1062 38.162 16.0809 36.6821 15.1712Z" fill="url(#paint2222_linear)"></path>
                                        <path d="M37.6525 27.6092C40.0536 21.9738 39.4157 16.3042 36.2275 14.9458C33.0394 13.5874 28.5084 17.0545 26.1072 22.6899C23.7061 28.3252 24.3441 33.9948 27.5322 35.3532C30.7203 36.7116 35.2513 33.2445 37.6525 27.6092Z" fill="#27DEB2"></path>
                                ...
                                <div class="ms-3 space-y-2">
                                    <p class="text-sm text-gray-900 dark:text-gray-100">
                                        پرداخت امن از <strong class="text-primary dark:text-primary-400">درگاه بانکی</strong>
                                    </p>
                                    <small class="text-gray-500 dark:text-gray-400 text-xs">
    ...
    <div class="py-8 bg-gray-200/50 dark:bg-[#0d1117] transition-colors duration-300">
        <div class="container">
            <div class="w-full px-4">
                <div class="flex flex-wrap gap-y-4">
                    ...
                    <div class="w-full mt-8">
                        <div class="flex flex-wrap">
                            <!--Logo-->
                            <div class="w-full lg:block hidden lg:w-2/12 relative">
                                <div class="relative w-56">
                                    ...
                                    <a href="#"  class="absolute start-0 end-0 text-center dark:mt-0 mt-7 block" onclick="scrollToTop(event)">
                                        ...
                                        <img src="<?= $assetsPath ?>images/logo/logo.png" class="size-15 mt-1 inline-block mx-auto dark:invert" alt="لوگو">
                                    </a>
                                </div>
                            </div>
                            <!--Description-->
    ...
    <!--Copyright-->
    <div class="py-10 bg-[#fcfcfc] dark:bg-[#0d1117] lg:mb-0 mb-15 transition-colors duration-300">
        <div class="container">
            <div class="flex sm:space-y-0 space-y-3 items-center justify-between flex-wrap">
                <p class="text-xs text-gray-700  dark:text-gray-400">
                    2025 © - تمامی حقوق مادی و معنوی برای فروشگاه اینترنتی دیارا محفوظ می‌باشد.
                </p>
