<?php if (!empty($breadcrumb) && is_array($breadcrumb)): ?>
    <nav class="w-full py-3" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center text-sm font-medium text-gray-700 dark:text-gray-400">
            <!-- خانه -->
            <li>
                <a href="<?= site_url('category') ?>" class="flex items-center hover:text-primary transition-colors">
                    <svg class="w-4 h-4 text-gray-500 dark:text-gray-400 hover:text-primary transition-colors" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
