                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-all">
                    ...
                    <td class="px-5 py-4">
                        <div class="flex space-x-2 rtl:space-x-reverse">
                            ...
                            <button type="button" title="حذف" aria-label="حذف" class="delete-btn text-blue-600 hover:text-blue-800" data-id="<?= $item['id'] ?>" data-url="<?= site_url(ADMIN_PATH . '/home-selected-category/delete') ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
