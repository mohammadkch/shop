            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="password" name="password" id="adminPassword"
                        ...
                        <button type="button" class="absolute password-toggle top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500" onclick="togglePassword('adminPassword', this)" aria-label="نمایش رمز عبور" title="نمایش رمز عبور">
