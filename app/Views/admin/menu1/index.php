                ...
                <div class="lg:col-span-3 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl drop-shadow-lg p-6 dark:bg-custom-dark dark:border dark:border-gray-700">
                            ...
                            <div class="mt-4 md:mt-0 flex flex-wrap gap-2">
                                ...
                                <a href="<?= site_url(ADMIN_PATH . '/menu1-image') ?>"
                                   class="bg-amber-500 text-white py-2.5 px-4 rounded-lg hover:bg-amber-600 transition duration-200 shadow-sm hover:shadow flex items-center">
                                    ...
                                    مدیریت تصاویر منوی 1
                                </a>
                                <!-- ======== پایان اضافه شد ======== -->

                                <a href="<?= site_url(ADMIN_PATH . '/menu1/create') ?>" class="bg-primary text-white py-2.5 px-4 rounded-lg hover:bg-primary-600 transition duration-200 shadow-sm hover:shadow flex items-center">
                                    <svg class="w-5 h-5 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div id="search-result">
                            <?= $this->include('admin/menu1/index_data_table') ?>
                        </div>
                    </div>
