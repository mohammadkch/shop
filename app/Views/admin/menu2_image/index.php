                ...
                <div class="lg:col-span-3 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl drop-shadow-lg p-6 dark:bg-custom-dark dark:border dark:border-gray-700">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                            <div>
                                <h1 class="font-black text-2xl with-highlight dark:text-gray-200">مدیریت تصاویر منو سطح 2</h1>
                                <p class="text-gray-600 dark:text-gray-400 mt-1">لیست تمام تصاویر منوهای سطح دوم فروشگاه</p>
                            </div>
                        </div>
                        ...
                        <div id="search-result">
                            <?= $this->include('admin/menu2_image/index_data_table') ?>
                        </div>
                    </div>
