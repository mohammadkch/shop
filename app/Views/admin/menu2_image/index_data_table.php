                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-all">
                    ...
                    <td class="px-5 py-4">
                        <div class="flex space-x-2">
                            ...
                            <?php if ($item['is_active'] != 1): ?>
                                <button type="button" title="حذف" aria-label="حذف" class="delete-btn text-red-600 hover:text-red-800" data-id="<?= $item['id'] ?>" data-url="<?= site_url(ADMIN_PATH . '/menu2-image/delete') ?>">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
