                ...
                <?php foreach ($blocks as $block): ?>
                    <section class="article-block">
                        <?php if (in_array($block['type'], ['text','text_image'], true)): ?>
                            <div class="article-content"><?= $block['content'] ?></div>
                        <?php endif; ?>
